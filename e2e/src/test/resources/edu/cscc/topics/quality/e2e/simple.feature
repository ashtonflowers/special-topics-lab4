...
#TODO:
# Fill out the step definition for this scenario. Note that when you go to your web site,
# clicking the hello button will send the browser to http://localhost:8080/hello
